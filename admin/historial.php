...
// Verificar ejecución de consulta
if ($historial === false) {
...
<div class="flex h-screen">
  ...
  <aside class="w-64 bg-white shadow-lg border-r flex flex-col justify-between">
    <div>
      ...
      <div class="p-4">
        <nav class="space-y-1">
          <a href="dashboard.php?seccion=dashboard" class="block px-4 py-2 rounded hover:bg-blue-50">📊 Dashboard</a>
          <a href="dashboard.php?seccion=pedidos" class="block px-4 py-2 rounded hover:bg-blue-50">📝 Pedidos</a>
          <a href="dashboard.php?seccion=platos" class="block px-4 py-2 rounded hover:bg-blue-50">🍽️ Platos</a>
          <a href="historial.php" class="block px-4 py-2 rounded bg-yellow-100 text-gray-800">🕒 Historial</a>
  ...
  <main class="flex-1 overflow-y-auto p-8">
    <div class="bg-white p-6 rounded-xl shadow border border-gray-300">
      <h1 class="text-2xl font-semibold mb-4">🕒 Historial de Cambios</h1>
