...
// Contar pedidos hechos hoy para este plato
...
<body class="bg-gray-100 p-6 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-xl p-6 flex flex-col md:flex-row justify-between gap-6">
        ...
        <div class="w-full md:w-1/2">
            ...
            <p class="text-gray-500 mt-1 text-sm">Disponibles hoy: <?= $disponibles ?></p>
        </div>

        <!-- Formulario de pedido -->
        <?php if ($bloqueado): ?>
            <div class="w-full md:w-1/2 flex items-center justify-center text-center">
                <p class="text-red-500 font-bold text-lg">❌ Límite de pedidos alcanzado para este plato hoy. No puedes reservar más.</p>
            </div>
        <?php else: ?>
